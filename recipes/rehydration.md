...
```ts
import { useActions, Rehydrate, Action } from "chizu";
...
Rehydrate(model, { UserId: 10 });

// Compound keys work too
Rehydrate(model, { Tab: "settings", UserId: 5 });
```
